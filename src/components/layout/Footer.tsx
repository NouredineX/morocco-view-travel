      ...
      <div className="container footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-col" id="footer-col-about">
            ...
            <p className="footer-about-text">
              {t('footer.aboutText', 'Travelling Through Morocco is your trusted partner for authentic Moroccan travel experiences. Based in Meknes, we offer premium tours and private transportation across the kingdom.')}
            </p>
          </div>
        ...
        <div className="footer-bottom" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}>
          ...
          <div className="social-links" id="footer-socials">
            ...
            <a href="https://www.tripadvisor.com" target="_blank" rel="noopener noreferrer" aria-label="TripAdvisor" id="social-ta">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
